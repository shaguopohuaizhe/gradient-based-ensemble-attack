...
import cv2
from attacks import G2BASE
        
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--input_dir', default='./small_imagenet/', type=str, help='path to data')
    parser.add_argument('--output_dir', default='./g2base/', type=str, help='path to results')
    ...
    model_ensemble = [model_rn, model_dn, model_adv, model_denoise]
