...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default='./single/', type=str, help='path to results')
    ...
    adversary = LinfMomentumIterativeAttack(
        model_adv, loss_fn=nn.CrossEntropyLoss(reduction="sum"), eps=args.max_norm/255, nb_iter=args.steps, eps_iter=2*args.max_norm/args.steps/255, decay_factor=0.9, clip_min=0., clip_max=1., targeted=False)
    print("adversary set")
