...
import cv2
from attacks import ensembleinlogits
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default='./ensembleinlogits/', type=str, help='path to results')
    ...
    #ensemble
    model_ensemble = Ensemble([model_rn, model_dn, model_denoise, model_adv])
